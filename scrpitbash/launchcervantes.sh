...
sudo cp ~/projet-cloud-virt/confignomadconsul/confconsulcervantes /etc/consul/consul.hcl
sudo cp ~/projet-cloud-virt/confignomadconsul/confnomadcervantes /etc/nomad/nomad.hcl
